  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
    ...
    <div>
      ...
      <div className="flex space-x-5 mt-4">
        <a title="discord" href="https://discord.com" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-400 transition">
        ...
        <a title="twitter" href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-sky-400 transition">
        ...
        <a title="instagram" href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500 transition">
